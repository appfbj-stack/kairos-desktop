...
export const anthropicAdapter = {
    ...
    async invoke(_request) {
        ...
        throw new ProviderError('Anthropic native adapter ainda nao implementado. Use OpenRouter (openrouter.ai) com chave OPENROUTER_API_KEY para acessar Claude.');
    },
    estimateCost(model, inputTokens, outputTokens) {
        ...
        return Promise.resolve((inputTokens / 1_000_000) * r.in + (outputTokens / 1_000_000) * r.out);
    },
};
